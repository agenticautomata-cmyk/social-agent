...
/** User-facing copy and labels — API field names unchanged. */
...
const LEGACY_STATE_LABELS: Record<string, string> = {
  planned: 'planned',
...
const BENSON_STATE_LABELS: Record<string, string> = {
  planned: 'discovered',
...
const LEGACY_FILTER_LABELS: Record<string, string> = {
  '': 'all',
  planned: 'planned',
...
const BENSON_FILTER_LABELS: Record<string, string> = {
  '': 'all',
  planned: 'discovered',
  script_drafted: 'pending_review',
  video_generating: 'processing',
...
export function getTerminology(): TerminologyCopy {
  return isBensonTerminology ? bensonTerminology : legacyTerminology;
}
...
export { LEGACY_STATE_LABELS, BENSON_STATE_LABELS };
